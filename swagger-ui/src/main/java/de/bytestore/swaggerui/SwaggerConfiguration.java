package de.bytestore.swaggerui;
...
@PropertySource(name = "de.bytestore.swaggerui", value = "classpath:/de/bytestore/swaggerui/module.properties")
public class SwaggerConfiguration {

    @Bean("swagger_SwaggerViewControllers")
    public ViewControllersConfiguration screens(final ApplicationContext applicationContext,
        ...
        viewControllers.setBasePackages(Collections.singletonList("de.bytestore.swaggerui"));
        return viewControllers;
    }

    @Bean("swagger_SwaggerActions")
    public ActionsConfiguration actions(final ApplicationContext applicationContext,
        ...
        actions.setBasePackages(Collections.singletonList("de.bytestore.swaggerui"));
        return actions;
    }
}
